...
import com.swipentap.chromium.R;
...
public class ShellManager extends FrameLayout {
    ...
    public static String DEFAULT_SHELL_URL = "http://www.google.com";
    private static boolean sStartup = true;
    protected WindowAndroid mWindow;
    protected Shell mActiveShell;

    protected String mStartupUrl = DEFAULT_SHELL_URL;
    ...
    @SuppressWarnings("unused")
    @CalledByNative
    protected void closeShell(Shell shellView) {
