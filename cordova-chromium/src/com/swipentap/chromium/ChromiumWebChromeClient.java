...
public class ChromiumWebChromeClient {
   ...
   */
  public void onProgressChanged(CordovaChromiumView view, int newProgress) {}
   ...
   */
  public void onReceivedTitle(CordovaChromiumView view, String title) {}
   ...
   */
  public void onReceivedIcon(CordovaChromiumView view, Bitmap icon) {}
   ...
   */
  public void onReceivedTouchIconUrl(CordovaChromiumView view, String url,
          boolean precomposed) {}
   ...
   *         undefined behavior.
   */
  public boolean onCreateWindow(CordovaChromiumView view, boolean isDialog,
   ...
   */
  public void onRequestFocus(CordovaChromiumView view) {}
   ...
   */
  public void onCloseWindow(CordovaChromiumView window) {}
   ...
   */
  public boolean onJsAlert(CordovaChromiumView view, String url, String message,
          ChromiumJsResult result) {
      return false;
  }
   ...
   */
  public boolean onJsConfirm(CordovaChromiumView view, String url, String message,
          ChromiumJsResult result) {
      return false;
  }
   ...
   */
  public boolean onJsPrompt(CordovaChromiumView view, String url, String message,
          String defaultValue, ChromiumJsPromptResult result) {
      return false;
  }
   ...
   * @return boolean Whether the client will handle the confirm dialog.
   */
  public boolean onJsBeforeUnload(CordovaChromiumView view, String url, String message,
          ChromiumJsResult result) {
      return false;
  }
