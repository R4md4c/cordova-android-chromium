...
public class ChromiumWebViewClient {
   ...
   * url is about to be loaded in the current ChromeView. If ChromiumWebViewClient is not
   * provided, by default ChromeView will ask Activity Manager to choose the
   * proper handler for the url. If ChromiumWebViewClient is provided, return true
   ...
   */
  public boolean shouldOverrideUrlLoading(CordovaChromiumView view, String url) {
      return false;
  }
   ...
   *            database.
   */
  public void onPageStarted(CordovaChromiumView view, String url, Bitmap favicon) {
  }
   ...
   */
  public void onPageFinished(CordovaChromiumView view, String url) {
  }
   ...
   */
  public void onLoadResource(CordovaChromiumView view, String url) {
  }
   ...
   *         resource itself.
   */
  public WebResourceResponse shouldInterceptRequest(CordovaChromiumView view,
          String url) {
      return null;
  }
   ...
   */
  public void onReceivedError(CordovaChromiumView view, int errorCode,
   ...
   */
  public void onFormResubmission(CordovaChromiumView view, Message dontResend,
          Message resend) {
   ...
   */
  public void doUpdateVisitedHistory(CordovaChromiumView view, String url,
          boolean isReload) {
  }
   ...
   *
   * @param view The ChromeView that is initiating the callback.
   * @param handler A ChromiumSslErrorHandler object that will handle the user's
   *            response.
   * @param error The SSL error object.
   */
  public void onReceivedSslError(CordovaChromiumView view, ChromiumSslErrorHandler handler,
          SslError error) {
      handler.cancel();
  }
   ...
   * @hide
   */
  public void onProceededAfterSslError(CordovaChromiumView view, SslError error) {
  }
   ...
   *            visits.
   */
  public void onReceivedHttpAuthRequest(CordovaChromiumView view,
      ChromiumHttpHandler handler, String host, String realm) {
      handler.cancel();
  }
   ...
   */
  public boolean shouldOverrideKeyEvent(CordovaChromiumView view, KeyEvent event) {
      return false;
  }
   ...
   * @param event The key event.
   */
  public void onUnhandledKeyEvent(CordovaChromiumView view, KeyEvent event) {
  }
   ...
   */
  public void onScaleChanged(CordovaChromiumView view, float oldScale, float newScale) {
  }
   ...
   */
  public void onReceivedLoginRequest(CordovaChromiumView view, String realm,
