...
import com.swipentap.chromium.CordovaChromiumActivity;
 ...
 *      </plugins>
 */
public class CordovaActivity extends CordovaChromiumActivity implements CordovaInterface {
    ...
    */
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mShellManager = (CordovaShellManager) findViewById(R.id.shell_container);
     ...
     */
    public void init() {
        CordovaWebView webView = appView; //appView is inialized in finishInitialization
    ...
    public void loadUrl(String url) {
        ...
        if (this.appView == null) { //appView is initialized in finishedInitialization
            return;
        }
